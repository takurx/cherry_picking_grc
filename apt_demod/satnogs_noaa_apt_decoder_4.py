...
class satnogs_noaa_apt_decoder_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna=satnogs.not_set_antenna, bb_gain=satnogs.not_set_rx_bb_gain, decoded_data_file_path='/tmp/.satnogs/data/noaa4', dev_args='rtl=00000001', doppler_correction_per_sec=20, enable_iq_dump=0, file_path='/tmp/test.ogg', flip_images=0, if_gain=satnogs.not_set_rx_if_gain, iq_file_path='/tmp/iq.dat', lo_offset=100e3, ppm=0, rf_gain=satnogs.not_set_rx_rf_gain, rigctl_port=4532, rx_freq=90.4e6, rx_sdr_device='rtlsdr', sync=1, waterfall_file_path='/tmp/waterfall.dat'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "satnogs_noaa_apt_decoder_4")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--decoded-data-file-path", dest="decoded_data_file_path", type="string", default='/tmp/.satnogs/data/noaa4',
...
def main(top_block_cls=satnogs_noaa_apt_decoder_4, options=None):
    if options is None:
