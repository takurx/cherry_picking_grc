...
def argument_parser():
    ...
    parser.add_option(
        ...
        help="Set rtl=00000001 [default=%default]")
    parser.add_option(
    ...
    parser.add_option(
        "", "--iq-file-path", dest="iq_file_path", type="string", default='./iq.dat',
    ...
    parser.add_option(
        "", "--waterfall-file-path", dest="waterfall_file_path", type="string", default='./waterfall.dat',
